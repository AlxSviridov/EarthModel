    ...
    <div className="app-shell">
      ...
      {activeLab === 'orbit' && <main id="main" className="workspace">
        <div className="visual-column">
          ...
          <SceneBoundary title="The 3D Earth could not start" message="Your browser could not start the 3D view, or an image failed to load. The daylight chart below still works, and the Sky paths and Sundial labs are unaffected."><EarthScene /></SceneBoundary>
          <DaylightChart />
        </div>
